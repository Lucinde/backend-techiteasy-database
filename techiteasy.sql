-- Ik heb de database aangemaakt via PGadmin en niet handmatig.
-- Deze geeft onderstaande code:
...
-- Er hoeft geen aparte table gemaakt te worden voor de products, dit is een abstracte klasse en je heb geen overerving in de database
-- Geen camelcase in sql maar snake_case omdat Spring de camelcase hier ook naar omzet

-- De volgende codes heb ik gebruikt om de database te gaan vullen:
